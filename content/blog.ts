...
export const BLOG_POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    body: [
      ...
      { type: 'p', text: 'Outside that envelope, the behaviour changes. Hardness above 180 ppm — common across NCR, Pune, and most of borewell-fed Bangalore — deposits calcium carbonate on every wetted surface. Iron above 0.3 ppm leaves orange staining around the spout. Chlorine above 2 ppm — possible at the head of the municipal line in some cities — ages the rubber and silicone seals. None of this is a fault in the fitting. The fitting is performing exactly as designed, on water it was not designed for.' },
